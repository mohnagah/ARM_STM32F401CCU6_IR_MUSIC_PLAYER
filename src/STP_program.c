...
MGPIO_vSetOutputMode(HSTP_SHIFT_CLOCK,OUTPUT_PUSHPULL,SPEED_LOW);

MGPIO_vSetMode(HSTP_STORAGE_CLOCK,MODE_OUTPUT);
MGPIO_vSetOutputMode(HSTP_STORAGE_CLOCK,OUTPUT_PUSHPULL,SPEED_LOW);
}

void S2P_vSendPulse(void)
{
MGPIO_vWritePin(HSTP_SHIFT_CLOCK,GPIO_HIGH);
TIM3_voidSetBusyWait(1);
